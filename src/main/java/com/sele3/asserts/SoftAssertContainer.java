...
public class SoftAssertContainer {
    ...
    /**
     * Records {@code error} on the current thread without throwing. This is this container's
     ...
     * its own soft-assert entry point to a {@link SoftAssertContainer} instance's {@code ::record}
     * to collect into that same instance's thread-bound failure list.
     *
